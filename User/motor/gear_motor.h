...
#define FWD_L		   		 {digitalHi(GEARMOTOR_GPIO_PORT_2,GEARMOTOR_GPIO_PIN1);\
												digitalLo(GEARMOTOR_GPIO_PORT_1,GEARMOTOR_GPIO_PIN2);}

#define REV_L			     {digitalLo(GEARMOTOR_GPIO_PORT_2,GEARMOTOR_GPIO_PIN1);\
...
#define FWD_R		   		 {digitalHi(GEARMOTOR_GPIO_PORT_1,GEARMOTOR_GPIO_PIN3);\
												digitalLo(GEARMOTOR_GPIO_PORT_1,GEARMOTOR_GPIO_PIN4);}

#define REV_R			     {digitalLo(GEARMOTOR_GPIO_PORT_1,GEARMOTOR_GPIO_PIN3);\
