...
//TIM5 输入捕获通道1、2
#define            GENENAL_TIM5_CH1_GPIO_CLK      RCC_APB2Periph_GPIOA
#define            GENENAL_TIM5_CH1_PORT          GPIOA
#define            GENENAL_TIM5_CH1_PIN           GPIO_Pin_0
#define            GENENAL_TIM5_IC1PWM_CHANNEL    TIM_Channel_1
#define            GENENAL_TIM5_CH2_GPIO_CLK      RCC_APB2Periph_GPIOA
#define            GENENAL_TIM5_CH2_PORT          GPIOA
