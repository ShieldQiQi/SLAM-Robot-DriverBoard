...
static void GENENAL_TIM_GPIO_Config(void) 
{
  ...
  GPIO_InitStructure.GPIO_Pin =  GENENAL_TIM2_CH3_PIN|GENENAL_TIM2_CH4_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 
  GPIO_Init(GPIOA, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin =  GENENAL_TIM3_CH3_PIN|GENENAL_TIM3_CH4_PIN|GENENAL_TIM4_CH1_PIN|GENENAL_TIM4_CH2_PIN|GENENAL_TIM5_CH1_PIN|GENENAL_TIM5_CH2_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 
...
static void GENENAL_TIM_Mode_Config(void)
{
	...
	GENENAL_TIM_APBxClock_FUN(GENENAL_TIM2_CLK|GENENAL_TIM3_CLK|GENENAL_TIM4_CLK|GENENAL_TIM5_CLK,ENABLE);
